...
public class CensusAnalyserTest 
{
	...
	@Test
	 ...
	 @Test
		public void givenStateCensusCsv_ShouldReturn_CorrectNumberOfRecords() {
			try {	
				StateCensusAnalyser censusAnalyser = new StateCensusAnalyser();
				int numOfRecords;
				numOfRecords = censusAnalyser.loadStateCensusData(STATE_CENSUS_CORRECT_DATA_CSV_FILE_PATH);
				Assert.assertEquals(14, numOfRecords);
			} catch (CensusAnalyserException e) {
	 ...
	 @Test
	    public void givenStateCSVFile_WhenHeaderAbsent_throwException() {
	        try {
	            StateCensusAnalyser stateCensusAnalyserMain = new StateCensusAnalyser();
	 ...
	 @Test
	    public void givenStateCSVFile_WithWrongFormat_throwException() {
	        try {
	            StateCensusAnalyser stateCensusAnalyserMain = new StateCensusAnalyser();
	            stateCensusAnalyserMain.loadStateCensusData(WRONG_FILE_FORMAT);
	        } catch (CensusAnalyserException e) {
	            assertEquals(CensusAnalyserException.ExceptionType.CENSUS_INCORRECT_FILE_FORMAT, e.type);
	        }
	    }
